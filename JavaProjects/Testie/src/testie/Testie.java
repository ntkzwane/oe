...
public class Testie{
    ...
    public void printClasses(OWLOntologyImpl ont, IRI iri) throws URISyntaxException{
        for(OWLEntity cls : ont.getClassesInSignature()){
            ...
            //System.out.println("NestedClassExp2 :"+cls);
    ...
    public void printAnnotations(OWLOntology ont, IRI iri){
        ...
        System.out.println("ThingThang          :"+ont.getAxioms()+"\n");
    }
    ...
    public static void main(String[] args){
        try {
            ...
            OWLOntologyImpl ont = (OWLOntologyImpl) owlman.loadOntologyFromOntologyDocument(IRI.create(Testie.class.getResource(owlfile)));
